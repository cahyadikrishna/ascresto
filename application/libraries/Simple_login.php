     ...
     */
     public function login($username, $password) {
         ...
         if($query->num_rows() == 1) {
             ...
             $this->CI->session->set_flashdata('sukses','<b>!</b> Username atau password anda salah');
     ...
     public function cek_login() {
         ...
         if($this->CI->session->userdata('username') == '') {
             ...
             //set notifikasi
             $this->CI->session->set_flashdata('sukses','<b>!</b> Anda belum login, silahkan login / daftar');
     ...
     public function logout() {
         ...
         $this->CI->session->set_flashdata('sukses','Anda berhasil logout <b>!</b>');
         redirect(site_url('admin/login'));
     }
 }