        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form action="<?php base_url('admin/account/register') ?>" method="post" enctype="multipart/form-data" >
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" name="name" required="required" class="form-control form-control-user" id="exampleFirstName" placeholder="Name" value="<?php echo set_value('name'); ?>" />
                      <?php echo form_error('name'); ?>
                  </div>
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" id="exampleLastName" placeholder="Username" required="required" name="username" value="<?php echo set_value('username'); ?>" />
