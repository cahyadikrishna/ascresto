        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
            	<h1 class="mb-3 mt-5 bread">Search List</h1>
	            <p class="breadcrumbs"><span class="mr-2"><a href="<?php echo site_url('menu') ?>">Menu</a></span> <span>Search List</span></p>
            </div>
    ...
    <section class="ftco-section">
        ...
        <div class="row">
        	...
        	<div class="col-md-6 mb-5 pb-3">
             ...
             <?php if($foodSearch): ?>
              <?php foreach ($foodSearch as $fdsearch): ?>  
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url(<?php echo base_url('upload/food/'.$fdsearch->food_img) ?>);"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span><?php echo $fdsearch->food_name ?></span></h3>
	        				<span class="price"><?php echo number_format($fdsearch->food_price,0,",",".")?> IDR</span>
	        			</div>
	        			<div class="d-block">
	        			<p><span class="icon-attachment"></span> <?php echo $fdsearch->kategori_name ?></p>
	        			</div>
        			</div>
        		</div>
        <?php endforeach; ?>
                    <?php else : ?>
                     <p style="font-size: 18px;" align="center">There is no food kategori or name "<?php echo $key ?>"</p>
                      <?php endif ; ?>
        		        	</div>
          ...
          <div class="col-md-6 mb-5 pb-3">
            <h3 class="mb-5 heading-pricing ftco-animate">Drinks</h3>
               <?php if($drinksSearch): ?>
             <?php foreach ($drinksSearch as $drsearch): ?>
            <div class="pricing-entry d-flex ftco-animate">
              <div class="img" style="background-image: url(<?php echo base_url('upload/drinks/'.$drsearch->drinks_img) ?>);"></div>
              <div class="desc pl-3">
                <div class="d-flex text align-items-center">
                  <h3><span><?php echo $drsearch->drinks_name ?></span></h3>
                  <span class="price"><?php echo number_format($drsearch->drinks_price,0,",",".")?> IDR</span>
                </div>
                <div class="d-block">
                <p><span class="icon-attachment"></span> <?php echo $drsearch->kategori_name ?></p>
                </div>
              </div>
            </div>
   <?php endforeach; ?>
                     <?php else : ?>
             <p style=" font-size: 18px;" align="center">There is no drinks kategori or name "<?php echo $key ?>"</span></p>
                      <?php endif ; ?>
                      </div>
		            ...
		            <div class="tab-content ftco-animate" id="v-pills-tabContent">
		              	...
		              	<div class="row">
		              		...
		              		<div class="col-md-3">
						        		<div class="menu-entry"> 
						    					<a href="<?php echo site_url('menu/food/'.$fod->food_id) ?>" class="img" style="background-image: url(<?php echo base_url('upload/food/'.$fod->food_img) ?>);"></a>
						    					<div class="text text-center pt-4">
						    						<h3><a href="<?php echo site_url('menu/food/'.$fod->food_id) ?>"><?php echo $fod->food_name ?></a></h3>
		              ...
		              <div class="tab-pane fade" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-1-tab">
		                <div class="row">
		              	...
		              	<div class="col-md-3">
						        		<div class="menu-entry">
						    					<a href="<?php echo site_url('menu/drinks/'.$drik->drinks_id) ?>" class="img" style="background-image: url(<?php echo base_url('upload/drinks/'.$drik->drinks_img) ?>);"></a>
						    					<div class="text text-center pt-4">
						    						<h3><a href="<?php echo site_url('menu/drinks/'.$drik->drinks_id) ?>"><?php echo $drik->drinks_name ?></a></h3>
