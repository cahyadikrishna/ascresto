      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate">
            <h3>How To Make :</h3>
            <h2 class="mb-3"><?php echo $detail->food_name ?></h2>
            <p>
              <img src="<?php echo base_url('upload/food/'.$detail->food_img) ?>" alt="" class="img-fluid">
            </p>
            
            <p><?php echo nl2br(htmlspecialchars($detail->food_desc )); ?></p>
